...
//  */
// export function createSatisfier<T = any>(expected: any): Satisfier<T> {
...
//         diff.push(...detectDiff(actual, expected))
//       }
//       else if (actual.length === 0) {
//         diff.push({ path: [], expected: expected, actual })
//       }
//       else {
//         actual.forEach((a, i) => {
//           diff.push(...detectDiff(a, expected, [`[${i}]`], i))
//         })
//       }
